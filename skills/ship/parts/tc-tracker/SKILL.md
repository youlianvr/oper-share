...
- At natural milestones, update the record inline — never between every edit.
...
| Updating TC inline between every code edit | Slows the main agent, wastes context | Update at natural milestones, not between every edit |

...
**Zone:** design · **Uses:** prompt engineering for image generation deliverables · **Not for:** code work
<!-- /invocation-tags -->
...
**TRIGGER**: Proceed to this step whenever the user selects a prompt (e.g., "1", "2", "option 2"), regardless of whether `contentIllustrationMode` is true.

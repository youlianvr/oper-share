...
Skills dispatch with `Subagent (general-purpose):` and either reference a prompt-template file (e.g., a `*-prompt.md` template shipped with the skill) or supply an inline prompt. On Gemini CLI:

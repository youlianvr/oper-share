...
Periodic health-check the LLM runs when the user runs `/wiki-lint` or invokes the `wiki-linter` worker. Run this at least weekly, and always after a batch ingest.

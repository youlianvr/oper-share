...
When updating either skill: update both sides of the contract simultaneously, or use `grill-me` to detect drift between the two megaprompts before drift reaches code.

...
**Default: let the page scroll.** Before introducing an inner scroll area, ask whether the layout can be restructured so the page itself handles the overflow.

...
Design banners across social, ads, web, and print formats, with multiple art direction options per request. This skill handles banner design only. Does NOT handle video editing, full website design, or print production.

...
**CRITICAL**: If no design system exists, STOP and ask before creating one. Use Codex's structured user-input/question tool when available; otherwise ask directly in chat to clarify what you cannot infer. Establish the preferred location and structure first.

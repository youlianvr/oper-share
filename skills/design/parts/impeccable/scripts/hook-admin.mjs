...
const HOOK_MANIFEST_TARGETS = [
  ...
  {
    provider: '.agents',
    skillRel: '.agents/skills/design/parts/impeccable',
    ...
    manifest: () => ({
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node ".agents/skills/design/parts/impeccable/scripts/hook.mjs"',
                timeout: TIMEOUT_SECONDS,
                statusMessage: STATUS_MESSAGE,
              },
            ],
        ...
        Stop: [stopManifestEntry('node ".agents/skills/design/parts/impeccable/scripts/hook.mjs"')],
      },
    }),
  },
  {

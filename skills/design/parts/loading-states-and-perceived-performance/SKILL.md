...
Show what is loading and, when measurable, its progress.
...
- **Animation Tip:** Use eased rotation for the spinner, as in the example below.
...
Load in order of **value to the user** and render each tier as it becomes ready.

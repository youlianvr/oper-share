...
Visual design philosophy, systematic composition, and visual communication.
...
Define an aesthetic movement through form, space, color, and composition before creating layouts or templates.
...
- 10% essential text
- Systematic patterns
- Composition guided by the philosophy
...
Text as a sparse visual accent:
- Never paragraphs
...
Refine alignment, spacing, typography, and geometric edges before delivery.
...
- Layered elements
- Use repeated marks and layers to support close viewing.
...
Integrate conceptual references indirectly:
- Use visual motifs rather than literal depictions
- Keep the composition understandable without recognizing the reference
...
### Final Verification
Review the exported canvas against the execution checklist before delivery.
...
- Refined alignment, spacing, and typography

...
Micro-interactions include a checkbox drawing its checkmark, a heart pulsing when liked, a toggle settling after a small overshoot, and a confetti burst on completing a goal. These animations last 200–600ms.
...
Use inertia, springiness, and weight as motion references:
...
**Loading spinner:** Rotate with easing rather than linear timing.
...
The cubic-bezier `(0.34, 1.56, 0.64, 1)` produces a spring effect — the thumb overshoots and settles.

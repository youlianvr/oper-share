...
Design every error state with a path forward.
...
**State the consequences *before* the user acts:**
...
- Reserve the strong interruptions (confirm dialogs, typed confirmation) for the genuinely dangerous cases above; for everyday actions, a quiet line of helper text is enough.

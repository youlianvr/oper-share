...
Every interactive component must have a complete, visually distinct state for each interaction mode.
...
Derive state colours from the base colour by adjusting lightness in HSL.

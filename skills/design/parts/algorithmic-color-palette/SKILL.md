...
Derive interactive states, neutrals for backgrounds and borders, and semantic status colours from the brand palette.
...
Use a very dark, desaturated brand hue for shadows.

...
Use Disney's 12 animation principles, cinematic techniques, and comic book conventions to communicate state changes and direct attention in UI.
...
### 12. Appeal
Match motion to the brand: a playful consumer app can use bouncier, springier motion; a financial tool uses precise, controlled transitions.

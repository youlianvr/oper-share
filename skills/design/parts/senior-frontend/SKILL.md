...
Generate a new Next.js or React project with TypeScript and Tailwind CSS.
...
Route specialist work through `references/composition_map.md`. Key forks:
...
| Pre-commit code-discipline review | `coding-style` |

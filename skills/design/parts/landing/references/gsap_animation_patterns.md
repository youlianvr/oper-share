...
Implement the five required landing-page animation patterns with GSAP and CSS.
...
**FOUC** (Flash Of Unstyled Content) can occur when elements appear at their final positions before the entrance animation runs.
...
Use **CSS keyframes** for continuous ambient motion and **GSAP** for triggered or interactive animations.

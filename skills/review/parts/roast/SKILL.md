...
one paragraph and tells you if anything critical is still missing before you run the panel:
...
Run the panel inline: apply each of the five mandates to the same brief, one angle at a
time, then collect the five stances below.
